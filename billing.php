...
$billing_id = 1; // Replace with the actual billing ID
...
$pdf->Cell(0,10,'Invoice Number: '.$billing['invoice_number'],0,1);
$pdf->Cell(0,10,'Date: '.$billing['date'],0,1);
$pdf->Ln(10);
...
$pdf->Cell(0,10,'Order ID: '.$billing['order_id'],0,1);
